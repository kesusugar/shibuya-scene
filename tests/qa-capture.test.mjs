...
test('QA manifest preserves five original views and adds the primary Scramble High pair',()=>{assert.deepEqual(QA_CAPTURES.map(x=>x.file),['overview-day.png','overview-night.png','scramble-street-day.png','scramble-street-night.png','qfront-night.png','scramble-high-day.png','scramble-high-night.png']);});
