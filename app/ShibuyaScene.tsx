...
export default function Home(){
 ...
 const enterPlayer=()=>{const ctx=lifeEntry.hooks.current?.network?.ctx;
  ...
  if(!arsenal){arsenal=createArsenal();groups.dynamic.add(arsenal.effects.root);}
