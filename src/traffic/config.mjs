...
export const VEHICLES={
 taxi:{width:1.72,length:4.5,height:1.5,speed:10,accel:1.8,brake:4,weight:23,color:0x3f927c},
 ...
 bus:{width:2.35,length:9,height:3,speed:8,accel:1.2,brake:3,weight:5,color:0x8dafb5,majorOnly:true},
