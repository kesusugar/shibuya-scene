...
export const QUALITY={high:{total:420,idle:64,milling:36,groups:18},medium:{total:210,idle:30,milling:18,groups:8},low:{total:95,idle:12,milling:8,groups:3}};
...
export const RADIUS=.25,STEP=1.25,POOL_SIZE=480;
