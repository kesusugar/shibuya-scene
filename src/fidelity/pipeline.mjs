...
export const FIDELITY={dpr:1.5,shadow:4096,aoScale:.5,radius:2.5,thickness:1.5,samples:12,blend:.85,denoiseRings:2,denoiseSamples:12,exposure:1.08,environmentDay:.8,environmentNight:.55,bloomStrength:.55,bloomThreshold:3.8};
