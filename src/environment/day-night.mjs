...
float pool=0.14*pow(max(0.0,1.0-length(q)/34.0),2.0);
for(int i=0;i<4;i++){vec2 c=vec2(i<2?-20.0:20.0,mod(float(i),2.0)<0.5?-18.0:18.0);pool+=0.09*pow(max(0.0,1.0-length(q-c)/17.0),2.0);}
